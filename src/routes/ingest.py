...
async def start_ingestion_job(
    ...
    """Receives a manual PDF/CSV/TXT file upload and starts background vector ingestion."""
...
async def get_ingestion_status(job_id: str, admin: dict = Depends(verify_admin_jwt)):
